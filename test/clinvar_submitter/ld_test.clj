...
(is (=(prop= t "VariantInterpretation" "type")))
(println "resolve-id-test result: " (prop= t "VariantInterpretation" "type"))))
...
;(deftest ld1-test
;(testing "Test if a location, and a set of predicates of a,return the set of nodes mapping to a given property " 
;(is (= nil ld1-> t "VariantInterpretation" "type"))
;(println "ld1-test result:")))
